...
/* Clase que contiene los métodos de SELECT, INSERT, UPDATE 
 * y DELETE para la tabla de PERSONAS en MYSQL */
...
public class PersonasJDBC {
    ...
    /**
     * Constructor que asigna una conexion existente
     * para ser utilizada en los queries de esta clase
     ...
     * @param persona_id Es la llave primaria 
